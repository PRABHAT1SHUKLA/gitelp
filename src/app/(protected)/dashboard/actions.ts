...
export async function askQuestion(question: string, projectId: string) {
  ...
  (async () => {
    const { textStream } = await streamText({
      ...
      Al is always friendly, kind, and inspiring, and he is eager to provide vivid and thoughtful responses to the user. AI has the sum of all knowledge in their brain, and is able to accurately answer nearly any question about any topic in the provided context.
